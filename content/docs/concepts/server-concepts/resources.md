...
icon: "category"
toc: true
description: "A standardized way for servers to expose resources to clients."
...
auto-completed through [the completion API](/docs/concepts/architecture-overview/layers/data-layer/utility-features/completion/).
